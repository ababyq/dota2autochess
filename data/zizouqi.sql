...
INSERT INTO `chess` VALUES (107, '小狗', 1, '噬魂鬼', '6', '22,32', 2, 107, 'npc_dota_hero_life_stealer_png.png', NULL, 'life_stealer_rage', '狂暴：进入狂暴状态，暂时获得魔法抗性加成，并免疫纯粹伤害', '无目标');
...
INSERT INTO `fetter` VALUES (19, 0, '7', '3工匠', 3, '如果主场战斗获胜有至少1个友方工匠存活，在下回合的准备回合开始时进行一次伟大的发明');
INSERT INTO `fetter` VALUES (20, 0, '7', '6工匠', 6, '伟大发明有概率升级为金色');
...
INSERT INTO `fetter` VALUES (30, 0, '12', '2武僧', 2, '所有友方近战武僧棋子造成伤害有概率立即消灭生命值过低的敌人');
INSERT INTO `fetter` VALUES (31, 0, '12', '4武僧', 4, '所有友方武僧棋子造成伤害有概率使生命值较高的敌方棋子当前生命值减半');
...
INSERT INTO `fetter` VALUES (44, 1, '17', '6娜迦', 6, '所有友方娜迦棋子获得效果：每次受到非纯粹伤害时，会反弹（自身魔法抗性所减免的伤害量×2）点伤害。');
...
INSERT INTO `fetter` VALUES (72, 1, '32', '1狗头人', 2, '为每种两两相同的友方棋子召唤一个复制品');
INSERT INTO `fetter` VALUES (73, 1, '32', '4狗头人', 4, '友方狗头人棋子将自己塑形为有一个同星的非狗头人友方棋子，以凑成两两相同');
...
INSERT INTO `fetter` VALUES (84, 0, '12', '6武僧', 6, '醉拳造成的伤害将为自己回复等量的生命值');
...
INSERT INTO `item` VALUES (22, '亲王短刀', 'item_qinwangduandao', 1, '普通', '攻击力+10。携带者对同种族/职业的敌方棋子造成的伤害+25%', 1, 'princes_knife_png.png', NULL);
...
INSERT INTO `item` VALUES (50, '韧鼓', 'item_rengu', 2, '普通', '光环：周围范围内的友军获得效果：攻击速度+25%', 1, 'ancient_janggo_png.png', 'item_yuanlingxidai;item_wangzhezhijie;item_lilianghuwan');
...
INSERT INTO `item` VALUES (93, '狗头人酒杯', 'item_goutourenjiubei', 3, '普通', '携带者视为狗头人。携带者及其同名棋子攻速+25%，变身棋子可以继承', 1, 'kobold_cup_png.png', '');
...
INSERT INTO `item_relic` VALUES (29, '启明星', 'item_super_uprank', 0, '圣物', '购买已拥有的棋子时有20%概率直接购买到★★棋子。根据棋子费用采用动态概率，费用越高概率越低，购买1/2/3/4/5费棋子的触发概率为24%/22%/20%/18%/16%', 'conjurers_catalyst_png.png', 1);
